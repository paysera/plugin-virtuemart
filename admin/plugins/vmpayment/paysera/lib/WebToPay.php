...
class WebToPay {
    ...
    public static function throwResponseError($code) {
        $errors = array(
            '0x1'    => self::_('mokÄ—jimo suma per maÅ¾a'),
            '0x2'    => self::_('mokÄ—jimo suma per didelÄ—'),
            '0x3'    => self::_('nurodyta valiuta neaptarnaujama'),
            '0x4'    => self::_('nÄ—ra sumos arba valiutos'),
            '0x6'    => self::_('klaidos kodas nebenaudojamas'),
            '0x7'    => self::_('iÅ¡jungtas testavimo reÅ¾imas'),
            '0x8'    => self::_('jÅ«s uÅ¾draudÄ—te Å¡Ä¯ mokÄ—jimo bÅ«dÄ…'),
            '0x9'    => self::_('blogas "paytext" kintamojo kodavimas (turi bÅ«ti utf-8)'),
            '0x10'   => self::_('tuÅ¡Äias arba neteisingai uÅ¾pildytas "orderid"'),
            '0x11'   => self::_('mokÄ—jimas negalimas, kol projektas nepatvirtintas arba jeigu jis yra blokuotas'),
            '0x12'   => self::_('negautas "projectid" parametras, nors jis yra privalomas'),
            '0x13'   => self::_('"accepturl", "cancellurl" arba "callbacurl" skiriasi nuo projekte patvirtintÅ³ adresÅ³'),
            '0x14'   => self::_('blogai sugeneruotas paraÅ¡tas ("sign" parametras)'),
            '0x15'   => self::_('klaidingi kai kurie iÅ¡ perduotÅ³ parametrÅ³'),
            '0x15x0' => self::_('neteisingas vienas iÅ¡ Å¡iÅ³ parametrÅ³: cancelurl, accepturl, callbackurl'),
    ...
    public static function getRequestSpec() {
        ...
        //  * user      â€“ if true, user can set value of this item, if false
        //                item value is generated.
        //  * isrequest â€“ if true, item will be included in request array, if
    ...
    public static function getMakroResponseSpec() {
        ...
        //  * name       â€“ request item name.
        //  * maxlen     â€“ max allowed value for item.
        //  * required   â€“ is this item is required in response.
        //  * mustcheck  â€“ this item must be checked by user.
        //  * isresponse â€“ if false, item must not be included in response array.
        //  * regexp     â€“ regexp to test item value.
        return array(
